	...
	<div class="wrapper__studios">
		<div class="wrapper__studios-room">
			...
			<p>
				...
				maxime, accusantium earum harum libero voluptatum. Provident corporis minus cum nostrum
				animi eveniet quasi, repellat voluptatum cumque earum.
			</p>
			<img class="img" src={StudioA} alt="studio A" />
			<img class="img" src={StudioB} alt="studio B" />
			<img class="img" src={StudioC} alt="studio C" />
			<img class="img" src={StudioD} alt="studio D" />
			<img class="img" src={StudioE} alt="studio E" />
			<img class="img" src={StudioF} alt="studio F" />
		</div>
