<!-- <script>
	...
	import Accor from '../../assets/logos/Accor.png';
	import Amplifon from '../../assets/logos/Amplifon.png';
	import Chanel from '../../assets/logos/Chanel.png';
	import Ferrero from '../../assets/logos/Ferrero.png';
	import Hermes from '../../assets/logos/Hermès.png';
	import Lenor from '../../assets/logos/Lenor.png';
	import ProtectGamble from '../../assets/logos/procterGamble.png';
	...
	const cards = [
		...
		{
			image: Accor,
            href: 'https://group.accor.com/fr-FR'
		},
		{
			image: Amplifon,
            href: 'https://www.amplifon.com/fr/'
		},
		{
			image: Chanel,
            href: 'https://www.chanel.com/fr/'
		},
		{
			image: Ferrero,
            href: 'https://www.ferrerogroup.com/fr/'
		},
		{
			image: Hermes,
		...
		{
			image: BMW,
            href: 'https://www.bmw.fr/fr/home.html'
		},
		{
			image: burgerKing
		...
		{
			image: Costa,
            href: 'https://www.costa.fr/'
		},

		{
			image: Delacre,
            href: 'https://www.delacre.fr/'
		},
		{
			image: Disneyland,
...
<Splide {options} aria-label="Logos">
	{#each cards as card}
		<SplideSlide>
...
<script>
	...
	import BMW from '../../assets/Logos-Englsh/BMW_DEF.png';
	...
	import ProtectGamble from '../../assets/Logos-English/ProcterGamble DEF.png';
	import Fnac from '../../assets/logos/fnac-2-logo.png';
	...
	const cards = [
		...
		{ image: Accor, href: 'https://group.accor.com/fr-FR' },
		{ image: Amplifon, href: 'https://www.amplifon.com/fr/' },
		{ image: Chanel, href: 'https://www.chanel.com/fr/' },
		{ image: Ferrero, href: 'https://www.ferrerogroup.com/fr/' },
		{ image: Hermes, href: 'https://www.hermes.com/fr/fr/' },
		{ image: Lenor, href: 'https://www.lenor.fr/' },
		{ image: ProtectGamble },
		{ image: BioMerieux, href: 'https://www.biomerieux.com/fr/' },
		{ image: BMW, href: 'https://www.bmw.fr/fr/home.html' },
		{ image: burgerKing, href: 'https://www.burgerking.fr/' },
		{ image: Costa, href: 'https://www.costa.fr/' },
		{ image: Delacre, href: 'https://www.delacre.fr/' },
